  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'rgba(10,15,12,0.55)', backdropFilter: 'blur(12px) saturate(1.1)', WebkitBackdropFilter: 'blur(12px) saturate(1.1)',
...
export const ModalShell: React.FC<ShellProps> = ({ title, subtitle, accent = GOLD, onClose, children }) => (
  <Backdrop onClose={onClose}>
    <div
      ...
      style={{
        ...
        background:
          'radial-gradient(ellipse at 8% 0%, rgba(248,206,85,0.16) 0%, transparent 55%),' +
    ...
    >
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          <div style={{ ...cap(9, '0.28em', accent), fontWeight: 700 }}>◆ KINGFALL</div>
          <div style={{
            fontFamily: DISPLAY, fontSize: 22, fontWeight: 900,
            color: CREAM, marginTop: 2, letterSpacing: '0.04em',
          }}>{title}</div>
          {subtitle && (
            <div style={{ fontFamily: BODY, fontStyle: 'italic', fontSize: 12, color: 'rgba(230,220,200,0.88)', marginTop: 2 }}>
              {subtitle}
            </div>
          )}
        </div>
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', gap: 10, alignItems: 'center', marginBottom: 14 }}>
        <div style={{ ...cap(10, '0.22em', CREAM), flex: 1 }}>
          PROGRESS · {claimed} / {missions.missions.length} CLAIMED
        </div>
        <button onClick={onReroll} className="kf-tap" style={{
          padding: '8px 14px', borderRadius: 8, cursor: 'pointer',
          background: 'rgba(192,124,230,0.14)', border: `1px solid ${VIOLET}55`,
          color: VIOLET, fontFamily: HEADING, fontSize: 10, letterSpacing: '0.22em', fontWeight: 700,
        }}>↻ REROLL</button>
      </div>
        ...
        {missions.missions.map(m => {
          ...
          return (
            <div key={m.templateId} style={{
              ...
              background: 'linear-gradient(180deg, rgba(40,20,60,0.45), rgba(20,10,35,0.65))',
              border: `1px solid ${done ? GREEN : VIOLET}44`,
            }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: 18, color: done ? GREEN : VIOLET,
                }}>{done ? '✓' : tpl.icon}</div>
                <div style={{ flex: 1 }}>
                  <div style={{ ...cap(11, '0.15em', CREAM), fontWeight: 700 }}>{tpl.label.toUpperCase()}</div>
                  <div style={{ fontFamily: BODY, fontSize: 12, color: 'rgba(230,220,200,0.9)' }}>{tpl.hint}</div>
                </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 10 }}>
                {m.claimed ? (
                  <div style={cap(10, '0.22em', GREEN)}>✓ CLAIMED</div>
                ) : done ? (
                  <button onClick={() => onClaim(m.templateId)} className="kf-tap" style={{
                    padding: '8px 16px', borderRadius: 8, cursor: 'pointer',
                    background: `linear-gradient(180deg, ${GREEN}dd, #14a04a)`,
  ...
  return (
    ...
    >
      <div style={{
        ...
        background: `linear-gradient(135deg, ${tier.color}22, rgba(20,20,30,0.6))`,
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={cap(9, '0.28em', VIOLET)}>CURRENT TIER</div>
            <div style={{ fontFamily: DISPLAY, fontSize: 24, fontWeight: 900, color: tier.color, marginTop: 2 }}>
              VIP {tier.label.toUpperCase()}
            </div>
            <div style={{ fontFamily: BODY, fontSize: 12, color: 'rgba(230,220,200,0.92)', marginTop: 4, fontStyle: 'italic' }}>
              {tier.perk}
            </div>
          </div>
        </div>
      ...
      <div style={{ ...cap(10, '0.28em', CREAM), marginBottom: 10, fontWeight: 700 }}>◆ ALL TIERS</div>
          ...
          return (
            <div key={t.tier} style={{
              ...
              background: isCurrent
                ? `linear-gradient(90deg, ${t.color}22, rgba(20,20,30,0.5))`
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontFamily: BODY, fontSize: 11, color: 'rgba(230,220,200,0.9)', marginTop: 2 }}>
                  {t.perk}
                </div>
              </div>
...
const LEADERBOARD_SEED: { name: string; chips: number; streak: number; flag: string }[] = [
  { name: 'CrownRoyal_88',  chips: 148_320, streak: 12, flag: '♛' },
  { name: 'JadeQueen',      chips: 112_450, streak: 8,  flag: '♛' },
  { name: 'IronDuke',       chips:  98_120, streak: 6,  flag: '◆' },
  { name: 'ShadowMonarch',  chips:  76_500, streak: 5,  flag: '◆' },
  { name: 'RubyRose_VIP',   chips:  62_800, streak: 4,  flag: '★' },
  { name: 'DiamondFang',    chips:  48_200, streak: 3,  flag: '★' },
  { name: 'VelvetKnight',   chips:  33_150, streak: 2,  flag: '✦' },
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', gap: 8, marginBottom: 14 }}>
        {(['chips', 'streak'] as const).map(k => (
          <button key={k} onClick={() => setTab(k)} className="kf-tap" style={{
            ...
            background: tab === k
              ? 'linear-gradient(180deg, rgba(240,192,64,0.24), rgba(80,60,20,0.4))'
              : 'rgba(255,255,255,0.03)',
            border: `1px solid ${tab === k ? GOLD : 'rgba(255,255,255,0.08)'}`,
            color: tab === k ? GOLD : CREAM,
      ...
      <div style={{
        ...
        background: `linear-gradient(90deg, ${GOLD}22, rgba(20,20,30,0.5))`,
        ...
        {withYou.slice(0, 11).map((row, i) => {
          ...
          return (
            <div key={row.name + i} style={{
              ...
              background: isYou
                ? `linear-gradient(90deg, ${GREEN}22, rgba(20,20,30,0.6))`
                : 'rgba(255,255,255,0.03)',
              border: `1px solid ${isYou ? GREEN : 'rgba(255,255,255,0.06)'}`,
              display: 'flex', alignItems: 'center', gap: 12,
            }}>
              <div style={{
                width: 30, textAlign: 'center',
                fontFamily: DISPLAY, fontSize: 16, fontWeight: 800,
                color: i === 0 ? GOLD : i === 1 ? '#c8d0e0' : i === 2 ? '#c48a3c' : CREAM,
              }}>{i + 1}</div>
              <div style={{ fontSize: 18, color: isYou ? GREEN : GOLD, width: 22, textAlign: 'center' }}>{row.flag}</div>
              <div style={{ flex: 1 }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 14, fontWeight: 700, color: isYou ? GREEN : CREAM }}>
                  {isYou ? 'YOU' : row.name}
                </div>
              </div>
              <div style={{ textAlign: 'right' }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 12 }}>
      {CHIP_SKIN_ORDER.map(id => {
        ...
        return (
          <div key={id} style={{
            padding: 14, borderRadius: 12,
            background: `linear-gradient(180deg, ${skin.boardDark}88, rgba(10,10,15,0.9))`,
            border: `1px solid ${equipped ? GREEN : skin.playerColor + '55'}`,
            boxShadow: equipped ? `0 0 20px ${GREEN}44` : 'none',
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{ ...cap(11, '0.22em', CREAM), fontWeight: 700 }}>{skin.label.toUpperCase()}</div>
            ...
            <button
              ...
              style={{
                ...
                border: `1px solid ${equipped ? GREEN : unlocked ? skin.playerColor : 'rgba(255,255,255,0.1)'}`,
                color: equipped ? GREEN : unlocked ? '#0a0a0a' : GOLD_INK,
...
export const PromotionsModal: React.FC<PromotionsModalProps> = ({ dailyBonus, onClaimDaily, onClose }) => {
  const promos = [
    ...
    },
    {
      ...
      body: 'Share Kingfall — both get 500 chips when your friend hits VIP Regular.',
      cta: 'SHARE LINK',
      pill: '+500 EACH',
      action: () => {
        try {
          if (navigator.share) navigator.share({ title: 'Kingfall Casino', text: 'Play checkers at Kingfall', url: window.location.href });
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 12 }}>
        {promos.map(p => (
          <div key={p.key} style={{
            ...
            background: `linear-gradient(135deg, ${p.accent}18, rgba(15,15,20,0.85))`,
            ...
            <div style={{ flex: '1 1 200px', minWidth: 180 }}>
              ...
              <div style={{ fontFamily: BODY, fontSize: 12, color: 'rgba(230,220,200,0.92)', marginTop: 4 }}>
                {p.body}
              </div>
            </div>
            <button
...
const CHIP_PACKS: { id: string; label: string; amount: number; accent: string; tag?: string }[] = [
  { id: 'starter', label: 'STARTER',  amount:    500, accent: '#c48a3c' },
  { id: 'stack',   label: 'STACK',    amount:  2_000, accent: '#c8d0e0' },
  { id: 'pile',    label: 'PILE',     amount:  5_000, accent: GOLD,     tag: 'POPULAR' },
  { id: 'vault',   label: 'VAULT',    amount: 15_000, accent: RED,      tag: '+15%' },
  { id: 'mountain',label: 'MOUNTAIN', amount: 50_000, accent: VIOLET,   tag: 'BEST VALUE' },
];
...
export const CashierModal: React.FC<CashierModalProps> = ({ points, onAddChips, onReset, onClose, onSfx }) => {
  ...
  return (
    ...
    >
      <div style={{
        padding: 16, borderRadius: 14, marginBottom: 16,
        background: `linear-gradient(135deg, ${GOLD}18, rgba(15,15,20,0.85))`,
        border: `1px solid ${GOLD}55`,
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontFamily: DISPLAY, fontSize: 26, fontWeight: 900, color: CREAM }}>
            {points.balance.toLocaleString()} <span style={{ fontSize: 14, color: GOLD_INK }}>CHIPS</span>
          </div>
        </div>
      </div>

      <div style={{ ...cap(10, '0.28em', CREAM), fontWeight: 700, marginBottom: 10 }}>◆ CHIP PACKS</div>
        ...
        {CHIP_PACKS.map(p => (
          <button
            ...
            style={{
              ...
              background: `linear-gradient(180deg, ${p.accent}22, rgba(15,15,20,0.9))`,
              border: `1px solid ${p.accent}66`,
              color: CREAM, position: 'relative', minHeight: 110,
            }}
          >
            {p.tag && (
              <div style={{
            ...
            <div style={{ fontFamily: DISPLAY, fontSize: 20, fontWeight: 900, color: CREAM, marginTop: 2 }}>
      ...
      <div style={{
        padding: 14, borderRadius: 12,
        background: 'rgba(240,77,92,0.06)',
        border: `1px solid ${RED}44`,
      }}>
        <div style={{ ...cap(10, '0.22em', RED), fontWeight: 700 }}>⚠ DANGER ZONE</div>
        <div style={{ fontFamily: BODY, fontSize: 12, color: 'rgba(230,220,200,0.88)', marginTop: 4 }}>
        ...
        {!confirmReset ? (
          <button
            ...
            style={{
              ...
              background: 'transparent', border: `1px solid ${RED}88`,
              color: RED, fontFamily: HEADING, fontSize: 10, letterSpacing: '0.22em', fontWeight: 700,
            }}
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 10 }}>
            <button
              ...
              style={{
                padding: '8px 14px', borderRadius: 8, cursor: 'pointer',
                background: RED, border: `1px solid ${RED}`, color: '#0a0a0a',
                fontFamily: HEADING, fontSize: 10, letterSpacing: '0.22em', fontWeight: 900,
              }}
            ...
            <button
              ...
              style={{
                padding: '8px 14px', borderRadius: 8, cursor: 'pointer',
                background: 'transparent', border: `1px solid ${GOLD_INK}`,
                color: CREAM, fontFamily: HEADING, fontSize: 10, letterSpacing: '0.22em', fontWeight: 700,
              }}
            >CANCEL</button>
          </div>
        )}
        ...
        {levels.map(level => {
          ...
          return (
            <div key={level} style={{
              ...
              <div style={{ flex: '1 1 200px', minWidth: 180 }}>
                <div style={{ fontFamily: DISPLAY, fontSize: 22, fontWeight: 900, color: cfg.color, letterSpacing: '0.05em' }}>
                  {cfg.label}
                </div>
                <div style={{ fontFamily: BODY, fontSize: 12, color: 'rgba(245,236,214,0.92)', marginTop: 4, fontStyle: 'italic' }}>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                ...
                <div style={{ padding: '8px 12px', borderRadius: 8, background: 'rgba(0,0,0,0.4)', border: '1px solid rgba(255,255,255,0.06)' }}>
                  ...
                  <div style={{ fontFamily: DISPLAY, fontSize: 16, color: GREEN, fontWeight: 800 }}>+{cfg.reward}</div>
                </div>
              </div>
              <button
                onClick={() => {
                ...
                style={{
                  ...
                  color: locked || !affordable ? GOLD_INK : '#0a0a0a',
      ...
      {ACHIEVEMENTS.map(a => {
        ...
        return (
          <div key={a.id} style={{
            ...
            background: got
              ? 'linear-gradient(180deg, rgba(240,192,64,0.22), rgba(80,60,20,0.4))'
              : 'rgba(255,255,255,0.02)',
            ...
            <div style={{ fontSize: 30, color: got ? GOLD : GOLD_INK }}>{a.icon}</div>
            <div style={{ ...cap(10, '0.15em', got ? CREAM : GOLD_INK), fontWeight: 700 }}>{a.label.toUpperCase()}</div>
            <div style={{ fontFamily: BODY, fontSize: 11, color: 'rgba(230,220,200,0.88)', lineHeight: 1.35, flex: 1 }}>
              {a.hint}
            </div>
            <div style={{ ...cap(9, '0.18em', got ? GREEN : GOLD_INK), fontWeight: 800 }}>
